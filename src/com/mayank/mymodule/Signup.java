...
public class Signup extends JFrame implements ActionListener{
    ...
    JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,image;
    ...
    long first4 = (ran.nextLong() % 7000L) + 1000L;
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            ...
            if(t6.getText().equals("")){
                ...
                Conn c1 = new Conn();
                String q1 = "insert into atm.signup values('"+formno+"','"+name+"','"+fname+"','"+dob+"','"+gender+"','"+email+"','"+marital+"','"+address+"','"+city+"','"+pincode+"','"+state+"')";
