    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(t2.getText().equals("")){
                ...
                Conn c1 = new Conn();
                String q1 = "insert into atm.signup2 values('"+formno+"','"+religion+"','"+category+"','"+income+"','"+education+"','"+occupation+"','"+pan+"','"+aadhar+"','"+scitizen+"','"+eaccount+"')";
...
//public class Signup2 extends JFrame implements ActionListener{
//	
//	private JLabel fno,l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,image,heading,page;
...
//			image = new JLabel(i3);
//			image.setBounds(10,10,250,90);//200,200
//			add(image);
//	        
//	        heading = new JLabel("WELCOME TO ATM");
//	        heading.setFont(new Font("Osward", Font.BOLD, 38));
//	        heading.setBounds(200,40,450,40);
//	        add(heading);
//		
//		
//		
//		page= new JLabel("Page 2 Additinal Details");
//	    page.setFont(new Font("Osward", Font.BOLD, 22));
//	    page.setBounds(200,100,100,50);
//	    add(page);
//	    
