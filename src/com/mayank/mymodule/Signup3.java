...
//-------------random generation of card number---------------------------------//        
        Random ran = new Random();
        long first7 = (ran.nextLong() % 90000000L) + 5040936000000000L;
        String cardno = "" + Math.abs(first7);
//-------------random generation of pin----------------------------------------//        
        ...
        try{
            if(ae.getSource()==b1){
                ...
                if(atype.equals("")){
                    ...
                    Conn c1 = new Conn();
                    String q1 = "insert into atm.signup3 values('"+formno+"','"+atype+"','"+cardno+"','"+pin+"','"+facility+"')";  
                    String q2 = "insert into atm.login values('"+formno+"','"+cardno+"','"+pin+"')";
